...
//gcc -g -o my_decode_video my_decode_video.c -L/usr/local/lib/ -lavcodec -lavfilter -lavutil -lavdevice -lavformat -lswscale -lavcodec
...
int main(int argc, char **argv)
{
	...
	if(!fmt_ctx){
		fprintf(stderr, "avformat_alloc_context Error  %s\n", filename);
		exit(1);
	}
	if(0 > avformat_open_input(&fmt_ctx, filename, NULL, NULL)){
